...
The computed SOTDs are stored [here](https://open.spotify.com/playlist/17eqTWTtmI2pm5cHuT4psH?si=9a2ed7f401a54340), and my mental SOTDs are stored [here](https://open.spotify.com/playlist/1TsgqA7bkOcBKJOhfiJm7U?si=81cd578f749a45fd). Updated every proper gym day. 

Daily computed SOTDs, regardless of gym status, are stored [here](https://open.spotify.com/playlist/5z0jE44oDlGiqckBhZOvVS?si=49fa61473c1e4eb7) via an automated workflow that runs daily.
...
* The alignment score is just a metric of how well my mental model scores align with the objective scores.